...
import {removeNote, setActive} from "../../app/notesSlice.ts";
...
const SidebarCard = (props: Props) => {
    ...
    return (
        <section className={cls.sidebarCard} onClick={clickCardHandler}>
            <h3>{note.title}</h3>
            <p>{note.text}</p>
                <button className={cls.iconButton} onClick={(e) => {removeNoteHandler(e)}}>
